  ...
  return request(params)
    .then(jsonResults => {
      ...
      if(count > 0) {
        ...
        const titleStr = `Here's ${count} result${count > 1 ? "s" : ""} related to *${params.body.q}*.:\n`
        ...
        return new telegramTemplate.Text(`*Sorry!* I couldn't find anything related to *${params.body.q}*.`).get()
      }
    })
    .catch(error => {
      return new telegramTemplate.Text(`*Sorry!* Something went wrong on our end. Will be back soon.`).get()
    }) 
}
